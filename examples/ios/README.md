...
The Stream screen embeds the derived RTMP/SRT HLS preview and WebRTC preview
while the stream is live. You can also open the printed HLS or WebRTC browser
preview URL on your computer.
