...
- **Camera**: request photo upload to the local demo cloud or directly to this iPhone, tune manual exposure and ISO, enable **Scan Mode** for document/barcode capture presets (max resolution, AE divisor, ISO cap, edge/MFNR off), then preview the received JPEG.
